...
flags.DEFINE_string('dataset_dir', 'out/train/', 'String: Your dataset directory')

#State your dataset directory
flags.DEFINE_string('test_dataset_dir', 'out/test/', 'String: Your test dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'usv', 'String: The output filename to name your TFRecord file')
...
def main():
    ...
    test_photo_filenames, test_class_names = _get_filenames_and_classes(FLAGS.test_dataset_dir)
    ...
    _convert_dataset('validation', validation_filenames, class_names_to_ids,
                     dataset_dir = FLAGS.test_dataset_dir, tfrecord_filename = FLAGS.tfrecord_filename, _NUM_SHARDS = FLAGS.num_shards)
